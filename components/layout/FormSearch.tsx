...
const FormSearch = () => {
  const { toggleSearch, searching, search }=React.useContext(Context) 
  return (
    <form className='w-full relative flex gap-1'>
     <div className="relative flex-1">
        <Input onChange={(e)=>searching(e)} value={search} type='text' placeholder='Type any product' className='peer' />
